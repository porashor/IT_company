...
const ClientArea = () => {
  return (
    <div>
        <div data-aos="zoom-in" className='my-5 md:my-10 bg-slate-100 py-5'>
        {/* container  */}
        <div className='w-[90%] md:w-[80%] mx-auto md:flex gap-5 items-center justify-between'>
            {/* left  */}
            <div data-aos="zoom-in" data-aos-delay="800" className='md:w-[45%]'>
            ...
            {/* right  */}
            <div data-aos='zoom-in' data-aos-delay="800" className='md:w-[50%]'>
